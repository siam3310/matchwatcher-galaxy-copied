          ...
          <div className="pt-2">
            ...
            <div className="grid grid-cols-4 gap-1 text-center">
              <div className="bg-card rounded p-1">
                <div className="text-lg font-semibold" id="days">
                  {timeRemaining.split(':')[0] || '0'}
                </div>
                <div className="text-xs text-muted-foreground">Days</div>
              </div>
              <div className="bg-card rounded p-1">
                <div className="text-lg font-semibold" id="hours">
                  {timeRemaining.split(':')[1] || '0'}
                </div>
                <div className="text-xs text-muted-foreground">Hours</div>
              </div>
              <div className="bg-card rounded p-1">
                <div className="text-lg font-semibold" id="mins">
                  {timeRemaining.split(':')[2] || '0'}
                </div>
                <div className="text-xs text-muted-foreground">Mins</div>
              </div>
              <div className="bg-card rounded p-1">
                <div className="text-lg font-semibold" id="secs">
